# Exercices sur les opérateurs de transformation
...
* [Exercice 1](./exercice-01/README.md) : Utiliser l'__Opérateur de Transformation__ `map`.

* [Exercice 2](./exercice-02/README.md) : Utiliser l'__Opérateur de Transformation__ `pluck`.
