...
* (__NEW__ !) [Exercice 1](./exercice-01) : Utiliser l'__Opérateur de Transformation__ `map`.

* (__NEW__ !) [Exercice 2](./exercice-02) : Utiliser l'__Opérateur de Transformation__ `pluck`.
